...
insert into bmt_user values ('aaa@aaa.aaa', 'aaa', '문경수', './DATA/PostImage/img001.jpg', '사용자정보를 길게 써보장', '좋아하는 코스aaa' , TO_DATE('2023/03/01 11:00:00', 'YYYY/MM/DD HH:MI:SS'), 'u' ) ;
...
insert into bmt_comment values (20031, 10060, ' 분간억분간억  ', TO_DATE('2023/03/09 12:38:00', 'YYYY/MM/DD HH:MI:SS'), 'eee@eee.eee');
insert into bmt_comment values (20032, 10060, ' 지루하지루하  ', TO_DATE('2023/03/09 12:39:00', 'YYYY/MM/DD HH:MI:SS'), 'bbb@bbb.bbb');
insert into bmt_comment values (20033, 10060, ' 진짜세진짜세  ', TO_DATE('2023/03/09 12:30:00', 'YYYY/MM/DD HH:MI:SS'), 'ddd@ddd.ddd');
...
insert into bmt_bic values ('WSBC021015577T', 'aaa@aaa.aaa', './DATA/bic_num_img/bic_num/1-1.png');
insert into bmt_bic values ('WTU189C0817T', 'aaa@aaa.aaa', './DATA/bic_num_img/bic_num/2-1.jpeg');
insert into bmt_bic values ('WTU190C7684T', 'aaa@aaa.aaa', './DATA/bic_num_img/bic_num/3-1.jpg');
insert into bmt_bic values ('WSBC001002294R', 'aaa@aaa.aaa', './DATA/bic_num_img/bic_num/4-1.jpg');
insert into bmt_bic values ('STR23D25221070081T', 'aaa@aaa.aaa', './DATA/bic_num_img/bic_num/5-1.jpg');
commit;



-- insert into bmt_follow values (bmt_fw_seq.NEXTVAL, 'ddd@ddd.ddd', 'ccc@ccc.ccc', TO_DATE('2023/03/05 11:05:00', 'YYYY/MM/DD HH:MI:SS'));